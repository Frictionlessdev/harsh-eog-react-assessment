...
export const FETCH_DRONE_LOCATION = "EVENT/FETCH_DRONE_LOCATION";
export const DRONE_LOCATION_RECEIVED = "EVENT/DRONE_LOCATION_RECEIVED";
export const FETCH_DRONE_LOCATION_WEATHER = "EVENT/FETCH_DRONE_LOCATION_WEATHER";